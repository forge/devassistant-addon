== devassistant
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The devassistant addon enables blah blah...)
...
----
<dependency>
   <groupId>org.devassistant</groupId>
   <artifactId>devassistant</artifactId>
